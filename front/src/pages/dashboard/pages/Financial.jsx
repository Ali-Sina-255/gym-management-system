...
const PREDEFINED_INDIVIDUAL_NAMES_FOR_FORM = ["حاجی عباس", "حاجی پرورش"];
        ...
        {!isFormVisible && (
          <div className="my-5 flex justify-center">
            <button
              ...
              className={` ${
                role == 3 ? "hidden" : ""
              } mb-4 bg-green-500 cursor-pointer hover:bg-green-600 text-white p-2 rounded shadow flex items-center gap-1`}
              disabled={isLoading}
            >
